...
export default function KV({ id, isStart, popupOpen }) {
  ...
  return (
    <div
      id={id}
      className="dev-yellow z-30 relative h-[64.3125rem] w-full bg-black sm:h-[45.9375rem]">
      ...
      <div className="center -z-20 absolute right-[6%] top-0 aspect-[503/417] w-[31.4375rem] overflow-hidden">
        <img
          src={`${baseUrl}/img/elvira-blumfelde-aqui3_h6LLM-unsplash.jpg`}
      ...
      <div className="text-display-1 z-10 absolute left-7 top-0 hidden w-[19.5rem] text-pr-1 sm:block">
        VIBE -400 2023
      </div>

      <div
        ref={movie}
        className="text-display-1 z-10 absolute -right-28 top-[40rem] text-pr-1 sm:-right-12 sm:top-[27.4rem]">
        Film
      </div>
      ...
      <div className="sm:center absolute left-20 top-[43.25rem] flex w-[29.625rem] flex-col gap-10 sm:top-[12.5rem] sm:w-[19.5rem] sm:gap-8">
        ...
        <button
          ...
          <div className="dev-red h-20 overflow-hidden">
